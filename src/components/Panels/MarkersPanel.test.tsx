...
describe('MarkersPanel', () => {
  ...
  it('clicking a row sets the cursor to the marker position and centers the view around it', () => {
    const doc = addDoc();
    ...
    render(<MarkersPanel />);
    fireEvent.click(screen.getByTestId('markers-row'));
  ...
  it('clicking a row near the start clamps scrollSample to 0 instead of going negative', () => {
    const doc = addDoc();
